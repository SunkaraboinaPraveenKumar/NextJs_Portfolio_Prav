  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-4 sm:left-10 w-32 h-32 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-4 sm:right-10 w-40 h-40 bg-primary/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/4 sm:left-1/3 w-24 h-24 bg-primary/5 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative w-full max-w-full lg:max-w-[700px] text-center lg:text-left mb-8 lg:mb-0 z-10">
        ...
        <div className="relative p-6 sm:p-8 lg:p-10 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 dark:from-gray-800/30 dark:to-gray-900/20 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 shadow-2xl hover:shadow-yellow-500/20 transition-all duration-500 group w-full">
          ...
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-primary/50 via-primary/20 to-primary/50 p-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          ...
          <div className="relative z-10 w-full">
            {/* Animated Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-primary/20 mb-6 animate-bounce shadow-lg shadow-orange-500/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start w-full">
              <a
                ...
                download="Resume.pdf"
                className="group relative overflow-hidden bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/25 inline-flex items-center gap-2 justify-center text-sm sm:text-base whitespace-nowrap"
              >
      ...
      <div className="relative flex justify-center items-center w-full lg:w-auto flex-shrink-0 z-10">
        <div className="relative group">
          ...
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary via-primary/50 to-primary p-1 animate-spin-slow group-hover:animate-spin">
            <div className="w-full h-full rounded-full bg-background"></div>
          </div>

          {/* Glow Effect */}
          <div className="absolute inset-0 rounded-full bg-primary/20 blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500 animate-pulse"></div>

...
const SkillsCarousel = () => {
  ...
  return (
    <div id="skills" className="min-h-screen bg-transparent py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-primary/10 rounded-full mb-4 sm:mb-6 shadow-lg shadow-primary/25 border border-primary/20">
            <Code2 className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-primary" />
          </div>
        ...
        <div className="relative">
          ...
          <button
            onClick={scrollLeft}
            className="hidden sm:flex absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 z-10 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-background/90 backdrop-blur-sm border border-border text-foreground rounded-full hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300 shadow-lg hover:shadow-primary/20"
          ...
          >
            {skills.map((data, index) => (
              ...
              >
                <Card className="group relative overflow-hidden bg-card backdrop-blur-sm border border-border hover:border-primary/50 shadow-xl hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 hover:-translate-y-2 h-full">
                  ...
                  <div className="relative p-6 lg:p-8 flex flex-col items-center justify-center text-center h-full min-h-[200px] sm:min-h-[220px]">
                    ...
                    <div className="relative mb-4 sm:mb-6">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-background to-secondary rounded-2xl p-3 sm:p-4 shadow-lg group-hover:shadow-primary/20 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 border border-border">
                        <Image
                        ...
                        />
                        <div className="w-full h-full bg-primary/10 rounded-xl hidden items-center justify-center">
                    ...
                    {/* Skill Title */}
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground group-hover:text-primary transition-colors duration-300 leading-tight">
                      {data.title}
                    </h3>
                    ...
                    {data.level && (
                      <div className="mt-3 w-full max-w-[120px]">
                        ...
                        <div className="w-full bg-secondary rounded-full h-2 overflow-hidden">
                          <div
                            className="bg-primary h-2 rounded-full transition-all duration-1000 group-hover:animate-pulse"
          ...
          <button
            onClick={scrollRight}
            className="hidden sm:flex absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 z-10 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-background/90 backdrop-blur-sm border border-border text-foreground rounded-full hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300 shadow-lg hover:shadow-primary/20"

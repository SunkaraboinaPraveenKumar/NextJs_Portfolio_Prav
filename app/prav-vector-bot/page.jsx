      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-slate-900 dark:to-black relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto p-6 relative z-10 pt-24">
          ...
          <header className="mb-8 text-center">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 backdrop-blur-sm border border-yellow-500/20 rounded-full px-6 py-3 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">
              <span className="text-orange-600 dark:text-transparent dark:bg-gradient-to-r dark:from-yellow-400 dark:via-orange-400 dark:to-orange-400 dark:bg-clip-text">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-slate-200 dark:border-slate-700/50 rounded-2xl p-4">
              <div className="flex items-center gap-3 mb-2">
                <Brain className="w-5 h-5 text-primary" />
                <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">AI Model</span>
              </div>
              <Select value={selectedModel} onValueChange={(value) => setSelectedModel(value)}>
                <SelectTrigger className="w-[280px] bg-slate-100 border-slate-300 text-slate-900 dark:bg-slate-800/50 dark:border-slate-600 dark:text-white rounded-xl">
          ...
          {/* Chat Container */}
          <div className="bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-slate-200 dark:border-slate-700/50 rounded-3xl shadow-2xl overflow-hidden">
            {/* Chat Header */}
            <div className="bg-gradient-to-r from-slate-100/50 to-slate-200/50 dark:from-slate-800/50 dark:to-slate-700/50 p-6 border-b border-slate-200 dark:border-slate-700/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">Praveen Kumar</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
                    {suggestions.map((suggestion, index) => {
                      ...
                      return (
                        <button
                          key={index}
                          className="group bg-slate-100/50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700/50 rounded-2xl p-4 hover:border-yellow-500/50 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-all duration-300 transform hover:scale-105 text-left"
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-slate-900 dark:text-white group-hover:text-yellow-600 dark:group-hover:text-yellow-300 transition-colors">
                                {suggestion.text}
                              </div>
                            </div>
                          </div>
                      ...
                      {!message.isLoading && message.role === "assistant" && (
                        <div className="flex items-center gap-2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-1 rounded-lg hover:bg-slate-700/50 text-slate-400 hover:text-primary transition-colors"
                          >
